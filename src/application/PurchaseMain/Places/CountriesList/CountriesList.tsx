...
const CountriesList: React.FC = () => {
  ...
  const headers = ['Country Name', 'Status', 'Action'];
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between p-4">
        <div className="flex flex-col md:flex-row items-center md:space-x-2">
          <span className="text-xl font-bold">Countries List</span>
          <span className="text-gray-500">View/Search Countries</span>
        </div>
        <div className="flex ">
          <div
      ...
      <div className="p-4 rounded-md border border-gray-600 shadow-md">
        <div className="flex justify-between items-center p-4">
          ...
          <CustomButton
            ...
            onClick={() => navigate('/purchase/places/newcountry')}
          >
            <Plus className="w-4 h-4" />
            <span>New Countries</span>
          </CustomButton>
        </div>
